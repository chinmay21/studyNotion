...
function Navbar() {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <div className="absolute top-14 left-0 w-full bg-richblack-800 text-white flex flex-col items-start gap-4 p-4 md:hidden z-50">
          ...
          <div className="flex flex-col gap-2 mt-4 w-full">
            ...
            {token === null ? (
              ...
              <ProfileDropdown  onLinkClick={() => setMenuOpen(false)} />
            )}
          </div>
        </div>
      )}
